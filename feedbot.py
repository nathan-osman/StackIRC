...
channel_list = [ "#2buntu" ] # Put in a list of channels
feed_list = [ "http://askubuntu.com/feeds/tag?tagnames=12.04&sort=newest"]
old_entries_file = os.environ.get("HOME") + "/.b0t/old-feed-entries"

irc = irclib.IRC()
server = irc.server()

server.connect( "irc.freenode.org", 6667, "j0seph_" ) # TODO: Make this general
